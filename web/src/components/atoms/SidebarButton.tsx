...
const Component: FC<Props> = ({ sidebar, tertiary, text, Icon, onClick }) => {
  return (
    <button
      onClick={onClick}
      className={`shadow overflow-hidden whitespace-nowrap w-full flex items-center py-2 px-4 bg-icons-highlight hover:bg-icons-secondary text-white rounded focus:outline-none gap-2
