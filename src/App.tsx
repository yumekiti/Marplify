    ...
    <div className="App bg-background h-screen">
      ...
      <div className='h-full pt-24 container mx-auto px-4'>
        ...
        <div className='h-5/6 grid grid-cols-2 gap-4 mt-4 py-2'>
          <div className='h-full col-span-1 bg-cardBackground rounded-l-lg pl-6 pt-4 relative'>
            <textarea className='w-full h-full bg-cardBackground resize-none outline-none'
          ...
          <div className='h-full col-span-1 bg-cardBackground rounded-r-lg px-6 pt-4 relative'>
            asdasdasd
            <div className='absolute bottom-14 right-24 rounded-b-lg'>
              <div className='fixed'>
                asdasd
